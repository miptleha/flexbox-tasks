...
**Hint:** Use `flex-wrap: wrap`, `justify-content: flex-start` and `gap: 20px`.

**Elements:**
- Images: `https://dummyimage.com/150x150/9b59b6/ffffff&text=Image+1` (change number 1-6 and size)
